RBots::Application.routes.draw do
  ...
  get 'get_account_info' => 'users#get_account_info'
  get 'login_reddit' => 'users#login_to_reddit'
  get 'about_me' => 'users#about_me'
  get 'show_subreddit' => 'users#show_subreddit'
